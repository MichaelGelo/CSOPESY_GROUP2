#ifndef ALLOCATORPAGING_H
#define ALLOCATORPAGING_H
...
#include <deque>
#include <queue>
class AllocatorPaging : public IMemoryAllocator {
public:

    AllocatorPaging(size_t maximumSize, size_t memoryPerFrame, size_t minMemoryPerProc, size_t maxMemoryPerProc);
    ~AllocatorPaging();
